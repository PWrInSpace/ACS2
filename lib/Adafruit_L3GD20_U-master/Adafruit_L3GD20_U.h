...
/*=========================================================================
    ...
    -----------------------------------------------------------------------*/
#define L3GD20_ADDRESS (0x68)     //!< L3gD20 I2C address; 1101011 in binary
#define L3GD20_POLL_TIMEOUT (100) //!< Maximum number of read attempts
#define L3GD20_ID (0xD1)          //!< L3GD20 ID
...
//#define GYRO_SENSITIVITY_1000DPS (0.035F)  //!< Sensitivity at 1000 dps
#define GYRO_SENSITIVITY_1000DPS (1000.0/32767.0)  //!< Sensitivity at 1000 dps
/*=========================================================================*/
...
typedef enum {                        // DEFAULT    TYPE
  GYRO_REGISTER_WHO_AM_I = 0x00,      // 11010100   r
  ...
  GYRO_REGISTER_OUT_X_L = 0x0C,       //            r
  GYRO_REGISTER_OUT_X_H = 0x0D,       //            r
  GYRO_REGISTER_OUT_Y_L = 0x0E,       //            r
  GYRO_REGISTER_OUT_Y_H = 0x0F,       //            r
  GYRO_REGISTER_OUT_Z_L = 0x10,       //            r
  GYRO_REGISTER_OUT_Z_H = 0x11,       //            r
...
public:
  ...
  bool begin(gyroRange_t rng = GYRO_RANGE_1000DPS, TwoWire *theWire = &Wire);
...
public:
  ...
  bool begin(l3gd20Range_t rng = GYRO_RANGE_1000DPS, byte addr = L3GD20_ADDRESS);
  void read(void);
